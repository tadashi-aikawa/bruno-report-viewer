  ...
  "rounded px-2 py-1 text-xs font-semibold border",
  {
    variants: {
      variant: {
        ...
        redirect: "border-amber-200",
        clientError: "border-rose-200",
    ...
    compoundVariants: [
      ...
      { variant: "redirect", tone: "filled", class: "bg-amber-100 text-amber-900", },
      { variant: "clientError", tone: "filled", class: "bg-rose-100 text-rose-900", },
      ...
      { variant: "redirect", tone: "outline", class: "text-amber-600 border-amber-400", },
      { variant: "clientError", tone: "outline", class: "text-rose-600 border-rose-400", },
